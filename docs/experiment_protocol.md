...
|---------|------------|--------------|--------|-------------------------------|
| **Low** | 2,000 events/s | 1,500 bytes | IoT sensor | 300 s |
| **Medium** | 10,000 events/s | 1,500 bytes | Financial tick | 300 s |
| **High** | 30,000 events/s | 1,500 bytes | Health monitor | 300 s |
...
- Base payload for official scenarios: 1,500 B
- JSON envelope overhead: ~200-300 B/event
- Approximate effective message size at Kafka ingress: ~1,600-1,900 B/event

Per-run estimates (300 s):

| Profile | Events/s | Duration | Expected events/run | Estimated generated volume/run |
|---------|---------:|---------:|--------------------:|-------------------------------:|
| Low | 2,000 | 300 s | 600,000 | ~0.95-1.1 GB |
| Medium | 10,000 | 300 s | 3,000,000 | ~4.8-5.6 GB |
| High | 30,000 | 300 s | 9,000,000 | ~14.4-16.8 GB |
...
| Generated bytes (producer-side) | ~86-101 GB |
